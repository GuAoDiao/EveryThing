...
void UReadyCountDown::NativeConstruct()
{
	...
	if (OwnerETGS_G)
	{
		UpdateReadyCountDownTime(OwnerETGS_G->GetReadyRemaningTime());
		OwnerETGS_G->OnReadyRemaningTimeUpdateDelegate.AddUObject(this, &UReadyCountDown::UpdateReadyCountDownTime);
	}
