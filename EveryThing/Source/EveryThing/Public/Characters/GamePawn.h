...
public:
	...
	bool CanConsumeForce(const FVector& Force) { return true; }
	bool CanConsumeTorqueInRadians(const FVector& Torque) { return true; }
	bool CanConsumeImpulse(const FVector& Impulse) { return true; }
};